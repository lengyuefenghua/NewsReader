...
fun FavoritesScreen(
    ...
    val descCheckboxSelectArticle = context.getString(R.string.desc_checkbox_select_article)

    var isSelectionMode by remember { mutableStateOf(false) }
    val selectedIds = remember { mutableStateListOf<String>() } // Article ID 是 String

    // Pre-load content description strings
    val descSearch = context.getString(R.string.desc_search)
    val descButtonUnfavoriteArticle = context.getString(R.string.desc_button_unfavorite_article)
                ...
                TopAppBar(
                    ...
                    actions = {
                        ...
                        IconButton(onClick = {
                            ...
                            isSelectionMode = false
                            selectedIds.clear()
                        }, modifier = Modifier.semantics { contentDescription = descButtonUnfavoriteArticle }) {
                            Icon(
                ...
                Column {
                    ...
                    OutlinedTextField(
                        ...
                        modifier = Modifier
                            ...
                            .semantics { contentDescription = descSearch },
                        singleLine = true
                    )
                }
            }
                        ...
                        if (isSelectionMode) {
                            Checkbox(
                                ...
                                modifier = Modifier.padding(start = 16.dp)
                                    .semantics { contentDescription = descCheckboxSelectArticle }
                            )
                        }
